            ...
            <div className="swiper-wrapper">
                ...
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <div className="slide-img" data-swiper-parallax="20%" style={{backgroundImage: "url(/dist/images/slides/4.jpg)"}}></div>
                    </div> 
                </SwiperSlide>
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <div className="slide-img" data-swiper-parallax="30%" style={{backgroundImage: "url(/dist/images/slides/8.jpg)"}}></div>
                    </div> 
                </SwiperSlide>
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <div className="slide-img" data-swiper-parallax="20%" style={{backgroundImage: "url(/dist/images/slides/7.jpg)"}}></div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <p className="slide-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi iusto dolorum adipisci molestiae laborum dignissimos recusandae maiores perspiciatis ab nemo provident ipsa quisquam quis iure amet corrupti, corporis quae odio!</p>
                        <div className="slide-img" data-swiper-parallax="30%" style={{backgroundImage: "url(/dist/images/slides/2.jpg)"}}></div>
                    </div> 
                </SwiperSlide>
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <p className="slide-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi iusto dolorum adipisci molestiae laborum dignissimos recusandae maiores perspiciatis ab nemo provident ipsa quisquam quis iure amet corrupti, corporis quae odio!</p>
                        <div className="slide-img" data-swiper-parallax="20%" style={{backgroundImage: "url(/dist/images/slides/5.jpg)"}}></div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="slides-item">
                        ...
                        <p className="slide-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi iusto dolorum adipisci molestiae laborum dignissimos recusandae maiores perspiciatis ab nemo provident ipsa quisquam quis iure amet corrupti, corporis quae odio!</p>
                        <div className="slide-img" data-swiper-parallax="30%" style={{backgroundImage: "url(/dist/images/slides/10.jpg)"}}></div>
                    </div> 
                </SwiperSlide>             
